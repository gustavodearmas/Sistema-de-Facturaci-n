...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash movie, send to contact
	...
	register: function(id, client) {
		// register new contact to receive events
	...
	Client: function(elem) {
		// constructor for new simple upload contact
		this.handlers = {};
		...
		// register contact with singleton to receive flash events
