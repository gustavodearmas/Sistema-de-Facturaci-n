...
( function( global, factory ) {
	...
	if ( typeof module === "object" && typeof module.exports === "object" ) {
		...
		// e.g. var jQuery = require("jqueryconfirm-3.4.4")(window);
	...
	preFilter: {
		...
		"PSEUDO": function( match ) {
			...
			// Strip excess characters from unquoted arguments
				...
				// advanced to the next closing parenthesis
...
jQuery.extend( jQuery.event, {
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		// Determine event propagation path in advanced, per W3C events spec (#9951)
			...
			return access( this, function( elem, type, value ) {
				...
				if ( isWindow( elem ) ) {
					...
					return funcName.indexOf( "outer" ) === 0 ?
						elem[ "inner" + name ] :
						elem.document.documentElement[ "contact" + name ];
				}
				...
				if ( elem.nodeType === 9 ) {
					...
					// Either scroll[Width/Height] or offset[Width/Height] or contact[Width/Height],
...
// way to register. Lowercase jqueryconfirm-3.4.4 is used because AMD module names are
