        ...
        var datatable = $('#k_recent_orders').KDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    return '<span class="k-label-fonts-color-3 k-fonts-bold">' + row.employee_id + '</span>';
                },
            }, {
                field: 'name',
                title: 'Customer',
                width: 130,
                template: function(row) {
                    return '<span class="k-label-fonts-color-3 k-fonts-bold">' + row.first_name + ' ' + row.last_name + '</span>';
                },
            }, {
                field: 'hire_date',
                title: 'Date',
                ...
                template: function(row) {
                    ...
                    return '<span class="k-badge k-badge--' + status[row.status].class + ' k-badge--dot k-badge--md"></span>&nbsp;&nbsp;<span class="k-label-fonts-color-2 k-fonts-bold">' +
