        ...
        css: function(el, styleProp, value) {
            ...
            if (value !== undefined) {
                ...
                if (defaultView && defaultView.getComputedStyle) {
                    ...
                    // (hyphen separated words eg. fonts-Size)
...
(function($) {
	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			...
			/**
			 * Insert data of array into {{ }} templates placeholder
			 * @param template
			 * @param data
			 * @returns {*}
			 */
	...
	$.fn[pluginName].defaults = {
		...
		rows: {
			...
			// call before row templates
			beforeTemplate: function() {
			},
			// call after row templates
